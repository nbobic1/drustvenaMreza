...
const FeedScreen = ({ navigation, route, C }) => {
    ...
    <View style={styles.container}>
      <View style={styles.feedView}>
        <View style={styles.top}>
          <InputV1 C={C} f={2} v={1} search={() => { }} onChangeText={(text) => { console.log("subimta"); setSearchText(text) }} ph='Search...' />
        </View>
        <View
          style={{ height: '93%' }}>
          <PostList C={C} DATA={DATA} searchText={searchText} ></PostList>
        </View>
      </View>
    </View>
  );
