    ...
    return (
        <View style={styles.root}>
            <View >
                ...
                <ButtonV1 my={S.m} w={'50%'} f={-1} title='Log in' onPress={() => { Login(email, password).then(async res => { console.log('token=', res); setToken(res); setLogedin(true); await SecureStore.setItemAsync('token', res); }) }}></ButtonV1>
